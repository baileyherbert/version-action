...
A GitHub Action which extracts the version from `github.ref`. Works on all platforms, and supports semver.

Forked from [battila7/get-version-action](https://github.com/battila7/get-version-action) with patches for deprecated features.
